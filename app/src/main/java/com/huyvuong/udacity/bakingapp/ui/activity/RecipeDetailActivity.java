...
public class RecipeDetailActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // configurations of this activity (e.g. when rotating the screen from portrait
        // to landscape). In this case, the fragment will automatically be re-added to its container
        ...
        if (savedInstanceState == null)
        {
            ...
            arguments.putLong(
                    ...
                    getIntent().getLongExtra(RecipeDetailFragment.ARG_ITEM_ID, 0L));
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            // This ID represents the Home or Up button. In the case of this activity, the Up button
            // is shown. For more details, see the Navigation pattern on Android Design:
            //
